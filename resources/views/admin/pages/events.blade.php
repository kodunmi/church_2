...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-event">Add New event</div>
        <div class="row">
            @foreach ($events as $event)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="/images/event/{{ $event->image }}" class="product-img-img" onclick="location.href='{{ route('event.feature',['id' => $event->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-event{{ $event->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-event{{ $event->id }}">
