...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-post">Add New post</div>
        <div class="row">
            @foreach ($posts as $post)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="/images/post/{{ $post->image }}" class="product-img-img" onclick="location.href='{{ route('post.feature',['id' => $post->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $post->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $post->title }}</p>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-post{{ $post->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-post{{ $post->id }}">
            ...
            @include('admin.modals.delete-post',['post' => $post])
            @include('admin.modals.edit-post',['post' => $post])
            @endforeach

        </div>
    </div>
    @include('admin.modals.add-post')
